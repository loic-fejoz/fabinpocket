...
build/index.html: index.html
	sed 's/fabinpocket.js/fabinpocket.min.js/g' $< | sed 's|js/jquery-2.1.4.min.js|https://ajax.googleapis.com/ajax/libs/jquery/2.1.4/jquery.min.js|g' | sed 's/fabinpocket.css/fabinpocket.min.css/g' > $@
